  ...
  render() {
    return (
      <div>
        ...
        <div className="hello-container slide-in-left">hello</div>
        ...
        <div className="about">
          ...
          <div className="about__content slide-in-bottom u-margin-bottom-m">
            <p className="about__content__text">
              I'm Peter Kim, software engineer, design enthusiast, and my mom's
              favorite.
            </p>
            <p className="about__content__text">
              Connect with me on{' '}
              <a
                href="https://www.linkedin.com/in/peter-kim-developer/"
